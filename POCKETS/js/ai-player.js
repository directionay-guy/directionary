...
class PocketsAI {
    ...
    evaluateSaveMove(dieValue, gameState) {
        ...
        // Late game: only save if exceptional
        else {
            if (dieValue === 6) {
                score = 8;
            } else {
                score = -10; // Almost never save in late game
            }
        }
